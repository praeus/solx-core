        ...
        SeedType {
            ...
            schema: json!({
                ...
                "properties": {
                    ...
                    "title": { "type": "string" },
                    "summary": { "type": "string" },
                    "typeRef": { "type": "string", "description": "Full reference of the document's type, e.g. /types/core/Object. Required on create." },
                    "contents": {},
                    "author": { "type": "string" },
                    "pubDate": { "type": "string" },
        ...
        SeedType {
            ...
            schema: json!({
                ...
                "properties": {
                    ...
                    "paramTypeRef": { "type": "string" },
                    "resultTypeRef": { "type": "string" },
                    "actionType": { "type": "string", "enum": ["wasm", "webhook", "command", "internal", "script"], "description": "Required on create." },
                    "fnName": { "type": "string", "description": "Command string / URL / internal op name / WASM export, depending on actionType." },
                    "binName": { "type": "string", "description": "Artifact file name (wasm: component; script: .solx source)." },
                    "actionConfig": {},
        ...
        SeedType {
            ...
            schema: json!({
                ...
                "properties": {
                    ...
                    "pathPrefix": { "type": "string" },
                    "typeRef": { "type": "string" },
                    "linkedTo": { "type": "string", "description": "Full reference of a document this search's hits must link to." },
                    "limit": { "type": "integer" },
                    "offset": { "type": "integer" },
                }
            }),
